        ...
        <Col md={6} lg={8} className="m-2">
          <Card className="overflow-hidden border-1 rounded-2 p-4">
            ...
            <Row>
              ...
              <Col sm={4} className=" text-warning text-end">
                <h6>
                  <b>Dikirim</b>
                </h6>
              </Col>
            ...
            <Row>
              <Col>
                <div className="d-flex justify-content-end">
                  <Link>
                    <Button variant="success" className="btn-table rounded-pill custom-button" onClick={handleShowDetail}>
                      Detail
                    </Button>

                    <Modal className="Action" show={showDetail} onHide={handleCloseDetail} backdrop="static" keyboard={false}>
                      <Modal.Header closeButton>
                        <Modal.Title>Catatan!!</Modal.Title>
                      </Modal.Header>
                      <Modal.Body>Pesanan sedang dalam perjalanan..</Modal.Body>
                      <Modal.Footer>
