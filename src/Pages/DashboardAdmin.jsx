              ...
              <table className="mb-0 pt-0">
                <tbody>
                  <tr>
                    ...
                    <td rowSpan="2">
                      <img style={{ height: "70px", background: "transparent", padding: "0px", marginTop: "20px" }}></img>
                    </td>
                  </tr>
                  <tr>
                    <td>Total Produk</td>
              ...
              <table className="mb-0 pt-0">
                <tbody>
                  <tr>
                    ...
                    <td rowSpan="2">
                      <img style={{ height: "80px", background: "transparent", padding: "0px", marginTop: "10px" }}></img>
                    </td>
                  </tr>
                  <tr>
              ...
              <table className="mb-0 pt-0">
                <tbody>
                  <tr>
                    ...
                    <td rowSpan="2">
                      <img style={{ height: "70px", background: "transparent", padding: "0px", marginLeft: "20px", marginTop: "20px" }}></img>
                    </td>
                  </tr>
                  <tr>
