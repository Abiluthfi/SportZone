import { Card, Col, Row, Container, CardBody, Button, Pagination, Form, FormControl, Modal } from "react-bootstrap";
              ...
              <Row className="bg-light align-items-center align-middle ">
                ...
                <Col sm={3}>
                  <div className="table-responsive">
                    <table className="table align-middle table-nowrap table-hover">
                      <tr>
                        <th className="text-center justify-content-center">Nama Lengkap</th>
                      </tr>
                    </table>
                  </div>
                </Col>
                <Col sm={2}>
                  <div className="table-responsive">
                    <table className="table align-middle table-nowrap table-hover">
                      <tr>
                        <th className="text-center justify-content-center">Username</th>
                      </tr>
                    </table>
                  </div>
                </Col>
                <Col sm={3}>
                  <div className="table-responsive">
                    <table className="table align-middle table-nowrap table-hover">
                      <tr>
                        <th className="text-center justify-content-center">Email</th>
                      </tr>
                    </table>
                  </div>
                </Col>
              ...
              <Row className="mt-3">
                  ...
                  <div className="table-responsive">
                    <table className="table align-middle table-nowrap table-hover">
                      <tr className=" text-align-center ">
                        <td className="text-center justify-content-center">Dean Andhika Ramadan</td>
                      </tr>
                    </table>
                  </div>
                </Col>
                <Col sm={2}>
                  <div className="table-responsive">
                    <table className="table align-middle table-nowrap table-hover">
                      <tr className=" text-align-center ">
                        <td className="text-center justify-content-center">deanzakir</td>
                      </tr>
                    </table>
                  </div>
                </Col>
                <Col sm={3}>
                  <div className="table-responsive">
                    <table className="table align-middle table-nowrap table-hover">
                      <tr>
                        <td className="text-center justify-content-center">Dean1212@gmail.com</td>
                      </tr>
                    </table>
                  </div>
                </Col>
